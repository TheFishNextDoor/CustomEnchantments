...
public class Loot {
    ...
    public static void addLoot(Plugin plugin, Player player, LivingEntity livingEntity, List<ItemStack> drops) {
        ...
        if (type == EntityType.ZOMBIFIED_PIGLIN && Utl.chance(0.1 * m)) drops.add(plugin.enchantedBook(plugin.REGENERATION, 1));
        if (type == EntityType.WITHER_SKELETON && Utl.chance(0.2 * m)) drops.add(plugin.enchantedBook(plugin.DEATHWISH, 1));
        if (type == EntityType.DROWNED && Utl.chance(0.2 * m)) drops.add(plugin.enchantedBook(plugin.WATER_BREATHING, 1));
        if (type == EntityType.HUSK && Utl.chance(0.2 * m)) drops.add(plugin.enchantedBook(plugin.HUNGER, 1));
        if (type == EntityType.SILVERFISH && Utl.chance(0.2 * m)) drops.add(plugin.enchantedBook(plugin.WORM, 1));
        if (type == EntityType.BLAZE && Utl.chance(0.2 * m)) drops.add(plugin.enchantedBook(plugin.FIRE_RESISTANCE, 1));;
        if (type == EntityType.GHAST && Utl.chance(0.2 * m)) drops.add(plugin.enchantedBook(plugin.SLOW_FALL, 1));
        if (type == EntityType.PIGLIN_BRUTE && Utl.chance(3.0 * m)) drops.add(plugin.enchantedBook(plugin.STRENGTH, 1));
        if (type == EntityType.EVOKER && Utl.chance(3.0 * m)) drops.add(plugin.enchantedBook(plugin.SPEED, 1));
        ...
        if (type == EntityType.CAVE_SPIDER) {
            ...
            if (Utl.chance(0.2 * m)) drops.add(plugin.enchantedBook(plugin.POISON, 1));
        }
        if (type == EntityType.SPIDER) {
            if (Utl.chance(0.1 * m)) drops.add(plugin.enchantedBook(plugin.CONFUSION, 1));
            if (Utl.chance(0.2 * m)) drops.add(plugin.enchantedBook(plugin.NIGHT_VISION, 1));
        }
        if (type == EntityType.ENDERMAN) {
            if (Utl.chance(0.1 * m)) drops.add(plugin.enchantedBook(plugin.AQUAPHOBIACURSE, 1));
            if (Utl.chance(0.2 * m)) drops.add(plugin.enchantedBook(plugin.TELEKINESIS, 1));
        }
        if (type == EntityType.PILLAGER) {
            if (Utl.chance(0.1 * m)) drops.add(plugin.enchantedBook(plugin.HERO_OF_THE_VILLAGE, 1));
            if (Utl.chance(0.2 * m)) drops.add(plugin.enchantedBook(plugin.REPLANTING, 1));
            if (Utl.chance(0.2 * m)) drops.add(plugin.enchantedBook(plugin.TILLING, 1));
            if (Utl.chance(0.2 * m)) drops.add(plugin.enchantedBook(plugin.REFLECTION, 1));
        }
        if (type == EntityType.PIGLIN) {
            if (Utl.chance(0.1 * m)) drops.add(plugin.enchantedBook(plugin.BLOODTIPPED, 1));
            if (Utl.chance(0.2 * m)) drops.add(plugin.enchantedBook(plugin.HASTE, 1));
        }
        if (type == EntityType.SHULKER) {
            if (Utl.chance(0.2 * m)) drops.add(plugin.enchantedBook(plugin.LEVITATIONCURSE, 1));
            if (Utl.chance(0.5 * m)) drops.add(plugin.enchantedBook(plugin.LEVITATION, 1));
        }
        ...
        if (type == EntityType.WITCH) {
            if (Utl.chance(0.2 * m)) drops.add(plugin.enchantedBook(plugin.WEAKNESS, 1));
        ...
        if (type == EntityType.GUARDIAN ) {
            if (Utl.chance(0.1 * m)) drops.add(plugin.enchantedBook(plugin.DOLPHINS_GRACE, 1));
        }
